    ...
    items: [
      { label: 'Dashboard', path: '/dashboard', icon: LayoutDashboard },
      {
        ...
        children: [
          ...
          { label: 'Extracurricular', path: '/student-affairs/extracurricular', icon: Dumbbell },
        ],
      },
      {
        label: 'HUBIM',
        ...
        icon: Building2,
        children: [
          { label: 'Companies', path: '/hubim/companies', icon: Factory },
          { label: 'Internships', path: '/hubim/internships', icon: BriefcaseBusiness },
          { label: 'Alumni', path: '/hubim/alumni', icon: GraduationCap },
        ],
      },
